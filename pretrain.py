...
from utils import eval_accuracy, collate_fn_transpose, NoamOpt, mask
from fault_dataset import MaskDataset

def pretrain_model(model, params):
    ...
    dataloader = DataLoader(data, batch_size=batch_size, shuffle=True, collate_fn = collate_fn_transpose)
